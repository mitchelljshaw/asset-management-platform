...
export function LoadingState({ label = "Loading..." }: { label?: string }) { // Loading spinner
  return (
...
export function ErrorState({ // Error with retry button
  message,
  onRetry,
}: {
  message: string;
...
export function EmptyState({ // Empty state with option for description/action button
  title,
  description,
  action,
}: {
