...
function toFormValues(initial?: Partial<AssetInput>): AssetInput { // Converts asset data (string) into form values
  return { 
...
function validate(values: AssetInput): FormErrors { // Checks required fields and rules before saving
...
function Field({ // Layout helper so every field gets the same label/error treatment
