...
function formatDate(value: string | null): string { // Database dates to Aus date format
  if (!value) return "—";
...
export default function AssetTable({ assets }: { assets: Asset[] }) { // Status, warranty and edit actions
  return (
