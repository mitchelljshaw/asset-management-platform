...
A full-stack internal IT asset management app for tracking company equipment 
such as laptops, monitors, phones, printers, and peripherals.

The app is designed like a small business or IT support team tool, replacing 
unreliable spreadsheets with a structured database, searchable asset list, 
dashboard, validation, and asset lifecycle actions.
